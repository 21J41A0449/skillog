...
export const UpvoteIcon = () => <IconBase className="w-5 h-5"><path d="M12 19V5M5 12l7-7 7 7"/></IconBase>;
export const GlobeIcon = () => <IconBase className="w-5 h-5"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></IconBase>;
export const CirclesIcon = () => <IconBase><path d="M12 12m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0"></path><path d="M12 3l0 2"></path><path d="M3 12l2 0"></path><path d="M12 21l0 -2"></path><path d="M21 12l-2 0"></path></IconBase>;
export const CloseIcon = () => <IconBase className="w-6 h-6"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></IconBase>;
